	...
	<div class="sns-top">
		<ol>
			...
			<?php if( function_exists('scc_get_share_pocket') && ! empty( scc_get_share_pocket() ) ): ?>
				<li class="pocket">
				<a href="https://getpocket.com/edit?url=<?php echo $url_encode;?>&title=<?php echo $title_encode;?>"><i class="jic jin-ifont-pocket" aria-hidden="true"></i>&nbsp;<?php if(function_exists('scc_get_share_pocket')) echo (scc_get_share_pocket()==0)?'':scc_get_share_pocket(); ?></a>
				</li>
			<?php else: ?>
				<li class="pocket">
