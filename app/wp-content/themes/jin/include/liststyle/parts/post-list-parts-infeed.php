		...
		<a class="post-list-link" rel="bookmark" href="<?php the_permalink() ?>" itemprop='mainEntityOfPage'>
			<div class="post-list-inner">
				...
				<div class="post-list-meta vcard">
					...
					<?php if (!is_mobile()) : ?>
						<span class="post-list-desc" itemprop="description"><?php if (mb_strlen($post->post_title) > 22) {
																				echo cps_excerpt(get_the_content(), 70);
																			} else {
																				echo cps_excerpt(get_the_content(), 90);
																			} ?>&nbsp;…</span>
					<?php endif; ?>
				</div>
			</div>
